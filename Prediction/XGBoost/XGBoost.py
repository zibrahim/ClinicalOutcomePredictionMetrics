...
from Prediction.Metrics import performance_metrics, brier
from Utils.DataUtils import  get_distribution, get_distribution_scalars
...
class XGBoostClassifier():
    ...
    def fit(self, label, sample_weights):
        ...
        scores = cross_validate(self.model.fit(X,y, sample_weight=sample_weights), X, y, obj=brier, scoring=['f1_macro', 'precision_macro',
    ...
    def plot_feature_importance( self ,colnames):
        ...
        colnames[len(colnames)-1] = 'Dynamic-KD'
        plt.figure(figsize=(10, 10))
        ...
        plt.savefig(self.output_path + self.outcome  + "FeatureImp.pdf", bbox_inches='tight')
